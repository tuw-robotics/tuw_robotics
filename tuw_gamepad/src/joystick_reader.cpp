...
int main() {
    ...
    if (joystick_fd == -1) {
        ...
        std::cerr << "Make sure the joystick is connected and you have permissions to read " << JOYSTICK_DEVICE << std::endl;
        std::cerr << "You might need to run: sudo usermod -a -G input $USER && newgrp input" << std::endl;
        return 1;
    }
