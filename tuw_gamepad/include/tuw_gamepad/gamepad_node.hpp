...
namespace tuw_gamepad
{
  ...
  private:
    ...
    std::string device;        /// static parameter: Joystick device default "/dev/input/js0"
    bool use_stamped_velocity; /// static parameter: On true it uses TwistStamped messages, otherwise Twist!
